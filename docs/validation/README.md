...
- Branded Safari/Windows Chrome/Edge support. Chromium headless and local Chrome visual checks are supporting evidence, not the whole support matrix.
